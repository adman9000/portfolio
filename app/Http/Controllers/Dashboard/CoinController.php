     ...
     public function index()
    {
        ...
        foreach($wallets as $wallet) {
            ...
            if($wallet->gbp_value > 1.00) {
                ...
                $wallet->coin->original_gbp_price = $valueBoughtAt ? $valueBoughtAt->gbp_price : $wallet->coin->gbp_price;
                $wallet->original_gbp_value = $valueBoughtAt ? $valueBoughtAt->gbp_value : $wallet->gbp_value;
